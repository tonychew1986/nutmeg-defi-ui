...
function PortfolioEarnList(props) {
  const {
    unstakeText,
    portfolioInfo,
    onUnstakeRedeem,
      ...
      <div className="actions">
        ...
        {close => (
          <div className="popupContent popupContentSmall">
            <PortfolioPopup unstakeText={unstakeText} asset={portfolio[0]} amount={portfolio[1]} onChangeAmount={onChangeAmount} inputAmount={inputAmount} onUnstakeRedeem={onUnstakeRedeem} onUpdateInputValue={onUpdateInputValue} inputVariableText={inputVariableText} />
...
PortfolioEarnList.propTypes = {};

export default PortfolioEarnList;
